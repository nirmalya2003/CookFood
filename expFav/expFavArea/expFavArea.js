...
searchBtn.addEventListener('click', (e)=> {
    ...
    if(!searchInput) {
        recipeContainer.innerHTML = `<h2>Type the meal area.</h2>`;
        return;
    }
...
const fetchRecipes = async (query) => {
    ...
    try {
        const data = await fetch(`https://www.themealdb.com/api/json/v1/1/filter.php?a=${query}`);
        ...
        recipeContainer.innerHTML = "<h2>Sorry, there is no recipe available by this area.</h2>";
    }
}
